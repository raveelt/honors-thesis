...
$$S = \sum_{i=1}^{N} w'_i$$
  ...
  We can now perform the normalization. Let $\tilde{w}$ describe our normalized edge-weights:
	...
	$$\Large\left[U_j \right]_{kk} = e^{2\pi i\gamma_{jk} (1 - \delta_{jk})}$$
	...
	\section{Identifying The Eigenstates}
	...
	\begin{enumerate}
	\item Here I will discuss how we determine the eigenstates associated with the hamiltonian cycles.
	\end{enumerate}
